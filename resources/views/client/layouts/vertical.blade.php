...
<head>
    ...
    <title>Client Dashboard / DNC</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="A fully featured client theme which can be used to build CRM, CMS, etc." name="description" />
    <meta content="Coderthemes" name="author" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="csrf-token" content="{{ csrf_token() }}">


        @include('client.layouts.shared.head')
...
<div id="app">
    ...
    <div id="wrapper">
        ...
        @include('client.layouts.shared.sidebar')
    ...
    @include('client.layouts.shared.footer-script')
