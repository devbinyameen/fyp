            ...
            <div class="card" style="min-height: 500px;">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                             @if( isset( $branch ) )
                            <form action="{{ route('client.branches.update',$branch->id)  }}" method="post" class="parsley-examples">
                            @else
                            <form action="{{ route('client.branches.store')  }}" method="post" class="parsley-examples">
                            @endif
                                @csrf
                                @if( isset($branch) )
                                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <select autocomplete="off" type="text" id="city" name="city" parsley-trigger="change"  placeholder="Enter City"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input autocomplete="off" type="time" id="opens" name="opens" parsley-trigger="change"  placeholder="Enter Opening time"
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input autocomplete="off" type="time" id="closes" name="closes" parsley-trigger="change"  placeholder="Enter Closing time"
                                ...
                                <div class="row mt-5">
                                    <div class="form-group btns-div col-12">
                                         <a href="{{ route('client.branches.index') }}" class="btn btn-md btn-light mr-5"> Cancel </a>
