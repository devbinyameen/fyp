...
{{--                                <a href="#"><img src="{{ asset('front/images/magazine/3.jpg') }}" alt="Image"></a>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <div class="col pl-3">--}}
...
{{--                        <div class="col-auto">--}}
{{--                            <div class="entry-image">--}}
{{--                                <a href="#"><img src="{{ asset('front/images/magazine/2.jpg') }}" alt="Image"></a>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <div class="col pl-3">--}}
{{--                            <div class="entry-title">--}}
...
{{--                        <div class="col-auto">--}}
{{--                            <div class="entry-image">--}}
{{--                                <a href="#"><img src="{{ asset('front/images/magazine/1.jpg') }}" alt="Image"></a>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <div class="col pl-3">--}}
{{--                            <div class="entry-title">--}}
